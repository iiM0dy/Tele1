                    ...
                    <div className="flex-1 flex justify-center lg:justify-center">
                        <div className="w-full max-w-[404px] lg:max-w-none flex justify-between lg:justify-center items-center">
                            ...
                            <Link href="/">
                                <img 
                                    alt="TELE1" 
                                    src="https://cdn.shopify.com/s/files/1/0724/7826/1570/files/asdfgh_x320.png?v=1727872249" 
                                    className="w-[65px] h-[53px] object-contain"
                                />
                            </Link>
                                            ...
                                            <div className="flex-1 min-w-0 text-left">
                                                ...
                                                {item.originalPrice && item.originalPrice > item.price && (
                                                    <div className="text-[0.75rem] color-[#707070] flex items-center gap-1 mt-0.5">
                                                        <span>DISCOUNT (-${(item.originalPrice - item.price).toFixed(2)})</span>
                                                    </div>
                                                )}
                                            </div>
                ...
                <div className="px-4 py-8 md:py-16 lg:px-12 flex justify-center lg:justify-end border-r border-[#e1e1e1] lg:border-r-0 order-2 lg:order-1">
                    <div className="w-full max-w-[404px]">
                        <form onSubmit={handleSubmit} className="space-y-8 text-left">
                            {/* Delivery Section */}
                            <section>
                                <h2 className="text-[1.35rem] font-medium text-[#1a1a1a] mb-4">Delivery</h2>
                                <div className="space-y-3.5">
                                    ...
                                    <div className="relative">
                                        ...
                                        <div className="absolute right-4 top-1/2 -translate-y-1/2">
                                            <HiOutlineQuestionMarkCircle className="w-5 h-5 text-[#707070]" />
                                        </div>
                                    </div>
                                </div>
                            </section>
