                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8 scrollbar-hide">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4 p-5 rounded-2xl bg-white/[0.02] border border-white/5">
                        <div className="space-y-2">
                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/60">{t('admin.currentStatus')}</p>
                        ...
                        <div className={`space-y-1 ${dir === 'rtl' ? 'text-left' : 'text-right'}`}>
                            <p className="text-[10px] font-black uppercase tracking-[0.2em] text-white/60">{t('admin.totalAmount')}</p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-4">
                            ...
                            <div className={`space-y-1 ${dir === 'rtl' ? 'mr-10' : 'ml-10'}`}>
                                ...
                                <p className="text-[11px] font-black text-white/60 uppercase tracking-widest" dir="ltr">{order.phone}</p>
                            </div>
                        </div>
                        <div className="space-y-4">
                            <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-white flex items-center gap-2">
                        ...
                        <div className="border border-white/5 rounded-3xl overflow-hidden bg-white/[0.01]">
                            <table className="w-full text-left border-collapse">
                                <thead className="bg-white/[0.02] border-b border-white/5">
                                    <tr>
                                        <th className={`p-4 text-[10px] font-black uppercase tracking-[0.2em] text-white/60 ${dir === 'rtl' ? 'text-right' : 'text-left'}`}>{t('admin.product')}</th>
                                        <th className="p-4 text-[10px] font-black uppercase tracking-[0.2em] text-white/60 text-center">{t('admin.qty')}</th>
                                        <th className={`p-4 text-[10px] font-black uppercase tracking-[0.2em] text-white/60 ${dir === 'rtl' ? 'text-left' : 'text-right'}`}>{t('admin.price')}</th>
                                        <th className={`p-4 text-[10px] font-black uppercase tracking-[0.2em] text-white/60 ${dir === 'rtl' ? 'text-left' : 'text-right'}`}>{t('admin.total')}</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-white/5">
                                    {order.items.map((item, idx) => (
                                        <tr key={idx} className="hover:bg-white/[0.02] transition-all group">
                                            ...
                                            <td className="p-4 text-center text-[10px] font-black uppercase tracking-widest text-white/60">
                                                {item.quantity}
                                            </td>
                                            <td className={`p-4 text-[10px] font-black uppercase tracking-widest text-white/60 ${dir === 'rtl' ? 'text-left' : 'text-right'}`}>
