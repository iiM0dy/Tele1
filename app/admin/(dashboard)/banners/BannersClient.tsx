                ...
                <div className="max-w-[1200px] mx-auto pb-10">
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-10 gap-6">
                        ...
                        {canManage && (
                            <button
                                onClick={handleAdd}
                                className="w-full md:w-auto bg-accent text-white px-8 py-3 rounded-2xl font-semibold text-sm hover:opacity-90 transition-all flex items-center justify-center gap-2 whitespace-nowrap"
                                ...
                                <div className="p-8 lg:p-10 flex-1 flex flex-col justify-between">
                                    <div className="flex flex-col gap-4">
                                        <div className="flex items-center gap-3">
                                            {!banner.isActive && (
                                                <span className="bg-white/5 text-white/40 px-3 py-1 rounded-full text-xs font-semibold border border-white/5">
                                                    {t('admin.hidden')}
                                                </span>
                                            )}
                                        </div>
                                        ...
                                        {banner.titleAr && (
                                            <div className="mt-4 pt-4 border-t border-white/5 flex flex-col gap-4">
                                                <h3 className="text-xl font-bold text-white text-right" dir="rtl">{banner.titleAr}</h3>
                                                <p className="text-sm text-white/60 line-clamp-2 text-right leading-relaxed" dir="rtl">
                                                    {banner.subtitleAr || t('admin.noSubtitle')}
                                                </p>
                                            </div>
                                        )}
                                        <div className="flex flex-col sm:flex-row gap-4 mt-4 p-5 bg-white/1 rounded-2xl border border-white/5">
                                            <div className="flex-1 flex flex-col">
                                                <span className="text-xs text-white/60 font-medium mb-1.5">{t('admin.button')}</span>
                                                <span className="text-sm font-medium text-white">{banner.buttonText}</span>
                                            </div>
                                            <div className="hidden sm:block w-px bg-white/5 h-full self-stretch" />
                                            <div className="flex-1 flex flex-col">
                                                <span className="text-xs text-white/60 font-medium mb-1.5">{t('admin.link')}</span>
                                                <span className="text-sm font-medium text-white truncate max-w-[300px]">{banner.link}</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center justify-between pt-8 mt-8 border-t border-white/5">
                                        <div className="flex items-center gap-4">
                                            <button
                                                ...
                                                className={`flex items-center gap-2 px-5 py-2.5 rounded-2xl text-sm font-semibold transition-all ${banner.isActive
