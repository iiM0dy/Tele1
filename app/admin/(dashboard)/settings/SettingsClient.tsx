            ...
            <div className="flex-1 flex flex-col h-screen overflow-hidden">
                <div className="flex-1 overflow-y-auto p-8">
                    <div className="max-w-2xl mx-auto">
                        <p className="text-center text-white/30 italic uppercase tracking-[0.2em] text-[10px] font-black">{t('admin.unableToLoadUser')}</p>
                    </div>
                </div>
            </div>
        );
                        ...
                        <form onSubmit={handleAccountSubmit} className="space-y-10">
                            ...
                            <div className="space-y-4">
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full h-14 px-5 rounded-2xl border border-white/5 bg-white/[0.02] text-white focus:border-accent/50 transition-all outline-none text-[10px] font-black uppercase tracking-[0.2em]"
                                />
                                <p className="text-[9px] text-white/30 font-black uppercase tracking-[0.2em] ml-1">
                                    {t('admin.requiredToVerify')}
                                </p>
                            </div>

                            <div className="border-t border-white/5 pt-10">
                                <h3 className="text-[10px] font-black text-white uppercase tracking-[0.2em] mb-8 opacity-30">
                                ...
                                <div className="bg-accent/10 border border-accent/20 rounded-2xl p-6 animate-in zoom-in-95 duration-300">
                                    <div className="flex gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-[9px] text-white/30 mt-1 uppercase tracking-[0.2em] font-black">
