...
function OrderSuccessContent() {
    ...
    return (
        <div className="bg-white min-h-screen">
            ...
            <header className="w-full flex items-center h-[107px] border-b border-zinc-800" style={{ backgroundColor: '#1B1B1B' }}>
                <div className="container mx-auto px-4 md:px-6">
                    <div className="grid grid-cols-3 items-center">
                        <div className="flex items-center">
                            <button className="md:hidden p-2 -ml-2 transition-colors" aria-label="Open navigation menu" style={{ color: 'rgb(250, 220, 145)' }}>
                            ...
                            <nav className="hidden md:flex items-center gap-6">
                                <Link className="text-[11px] font-bold uppercase tracking-[0.1em] transition-colors hover:text-white" href="/collections/chain-bracelet" style={{ color: 'rgb(250, 220, 145)' }}>Chain Bracelet</Link>
                                <Link className="text-[11px] font-bold uppercase tracking-[0.1em] transition-colors hover:text-white" href="/collections/chains" style={{ color: 'rgb(250, 220, 145)' }}>Chains</Link>
                                <Link className="text-[11px] font-bold uppercase tracking-[0.1em] transition-colors hover:text-white" href="/collections/cuff-bracelets" style={{ color: 'rgb(250, 220, 145)' }}>Cuff Bracelets</Link>
                                <Link className="text-[11px] font-bold uppercase tracking-[0.1em] transition-colors hover:text-white" href="/collections/pendants" style={{ color: 'rgb(250, 220, 145)' }}>Pendants</Link>
                                <Link className="text-[11px] font-bold uppercase tracking-[0.1em] transition-colors hover:text-white" href="/collections/watches" style={{ color: 'rgb(250, 220, 145)' }}>Watches</Link>
                            </nav>
                        </div>
                        <div className="flex justify-center">
                            <Link className="relative block" href="/">
                                <span className="sr-only">TELE1</span>
                                <span className="text-2xl md:text-3xl font-serif font-bold tracking-[0.3em] uppercase transition-colors" style={{ color: 'rgb(250, 220, 145)' }}>TELE1</span>
                            </Link>
                        </div>
                        <div className="flex items-center justify-end gap-3 md:gap-5">
                            <Link className="hidden sm:block transition-colors hover:text-white" href="/account" style={{ color: 'rgb(250, 220, 145)' }}>
                            ...
                            <button className="transition-colors hover:text-white" style={{ color: 'rgb(250, 220, 145)' }}>
                            ...
                            <Link href="/cart" className="relative transition-colors hover:text-white" style={{ color: 'rgb(250, 220, 145)' }}>
