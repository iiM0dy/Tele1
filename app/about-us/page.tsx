  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative h-[60vh] bg-black flex items-center justify-center overflow-hidden">
        {/* Abstract Background */}
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1550751827-4bd374c3f58b?q=80&w=2670&auto=format&fit=crop')] bg-cover bg-center opacity-30" />
      ...
      <section className="py-24 px-4 md:px-8 bg-white">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div className="relative aspect-[4/5] bg-zinc-100 rounded-2xl overflow-hidden group shadow-2xl">
             <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1491933382434-500287f9b54b?q=80&w=1000&auto=format&fit=crop')] bg-cover bg-center transition-transform duration-700 group-hover:scale-105" />
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-10 rounded-3xl border border-zinc-100 hover:border-accent/30 hover:shadow-xl transition-all duration-300 group">
              ...
              <h3 className="text-xl font-black uppercase tracking-tight mb-4">{t('about.quality')}</h3>
            ...
            <div className="bg-white p-10 rounded-3xl border border-zinc-100 hover:border-accent/30 hover:shadow-xl transition-all duration-300 group">
              ...
              <h3 className="text-xl font-black uppercase tracking-tight mb-4">{t('about.innovation')}</h3>
              <p className="text-zinc-500 leading-relaxed">
            ...
            <div className="bg-white p-10 rounded-3xl border border-zinc-100 hover:border-accent/30 hover:shadow-xl transition-all duration-300 group">
              ...
              <h3 className="text-xl font-black uppercase tracking-tight mb-4">{t('about.customer')}</h3>
              <p className="text-zinc-500 leading-relaxed">
