                                        ...
                                        {images.map((_, idx) => (
                                            <button 
                                                ...
                                                className={`w-1.5 h-1.5 rounded-full transition-all duration-300 ${
                                                    activeSlide === idx ? 'bg-zinc-800 scale-125' : 'bg-zinc-300 hover:bg-zinc-400'
                                                }`}
                        ...
                        <div className="sticky top-32">
                            ...
                            <div className="product-info__block-item pt-6" data-block-type="buy-buttons">
                                <button
                                    ...
                                    className="w-full h-[56px] bg-accent text-white rounded-xl flex items-center justify-center text-[13px] font-bold uppercase tracking-[0.2em] hover:bg-accent/90 transition-all shadow-lg shadow-accent/20 active:scale-[0.98]"
                                >
                                    Add to cart
                                </button>
                            </div>
